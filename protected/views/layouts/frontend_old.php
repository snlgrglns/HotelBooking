...
<head>
    ...
    <meta name="keywords" content="august lake resort, august, lake, resort, hotel, pokhara, nepal, lakeside, pame, augustlakeresort">
    <meta name="description" content="August Lake Resort">

    <title>August Lake Resort</title>
    <link rel="sitemap" type="application/xml" title="Sitemap" href="http://augustlakeresort.com/sitemap.xml" />
    <!-- Favicon -->
                                ...
                                <div class="container-fluid">
                                    ...
                                    <div class="collapse navbar-collapse" id="navbar-collapse-1">
                                        <ul class="nav navbar-nav navbar-right">
                                            ...
                                            <li <?php if(strtolower($cont.'/'.$act) == 'site/testimonial'){?>class="active"<?php } ?>><a href="<?php echo Yii::app()->request->baseUrl; ?>/site/testimonial">Testimonials</a></li>
    ...
    <?php echo $content; ?>
        ...
        <div class="container">
            <ul class="social-list">
                ...
                <li class="tripadvisor"><a target="_blank" href="http://www.tripadvisor.com/Hotel_Review-g293891-d8657132-Reviews-August_Lake_Resort-Pokhara_Gandaki_Zone_Western_Region.html"><i class="fa fa-yen"></i></a></li>
            </ul>
        </div>
    </div>
                        ...
                        <nav class="navbar navbar-default" role="navigation">
                            ...
                            <div class="collapse navbar-collapse" id="navbar-collapse-2">
                                <ul class="nav navbar-nav">
                                    ...
                                    <li><a href="<?php echo Yii::app()->request->baseUrl; ?>/site/testimonial">Testimonials</a></li>
