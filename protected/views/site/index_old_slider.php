                    ...
                    <?php if(!empty($slider)) {
                        foreach ($slider as $s) {
                            ...
                            <li data-transition="random" data-slotamount="7" data-masterspeed="500"
                                data-saveperformance="on" data-title="Premium HTML5 template">
                                <!-- main image -->
                                <img src="<?php echo Yii::app()->request->baseUrl . '/images/slider/fullsized/'.$s->image; ?>"
                                ...
                                <div class="tp-caption default_bg large sfr tp-resizeme"
                                     ...
                                     data-start="1200"
                                     data-end="9400"
                                     data-endspeed="600"><?php // echo strtoupper($s->title); ?></div>
                                <!-- LAYER NR. 2 -->
                                <!-- LAYER NR. 3 -->
<!--                                <div class="tp-caption light_gray_bg sfb medium tp-resizeme"
                                     ...
                                     data-start="1600"
                                     data-end="9400"
                                     data-endspeed="600">HOLIDAYS WITH OLD CLASSIC <span class="red-txt">HOTELS</span>!</div>-->
                            </li>
                            <!-- slide 1 end -->
                        <?php }
                    } ?>
                            ...
                            <div class="col-md-3 col-sm-6">
                                <div class="box-body">
                                    ...
                                    <div class="box-content">
                                        ...
                                        <div class="box-btn"><a target="_blank" href="<?php echo Yii::app()->request->baseUrl.'/site/aboutrm/'.$oth->room_id; ?>" class="btn btn-white pull-right">View Detail</a></div>
