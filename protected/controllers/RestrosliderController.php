...
class RestroSliderController extends Controller
{
	/**
	...
	public function actionActivate($id){
		$slider = RestroSlider::model()->findByPk($id);
		...
		$this->redirect(array('restroSlider/admin'));
	}
    ...
    public function createThumbnail($filename, $type) {
        ...
        $path_to_image_directory = 'images/restro_slider/fullsized/';
        $path_to_medium_directory = 'images/restro_slider/medium/';
        $path_to_thumbs_directory = 'images/restro_slider/thumbs/';
	...
	{
		$model=new RestroSlider;
        $rand = rand(1111, 9999);
		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['RestroSlider']))
		{
			$model->attributes=$_POST['RestroSlider'];
	...
	{
		$dataProvider=new CActiveDataProvider('RestroSlider');
	...
	{
		$model=new RestroSlider('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['RestroSlider']))
			$model->attributes=$_GET['RestroSlider'];
	 ...
	 * @return RestroSlider the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=RestroSlider::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param RestroSlider $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='restro-slider-form')
		{
